...
pathTicker = '/Users/andrew/Desktop/HKUST/Projects/IB/Test_1101/Data/HKCombine/Tickers_adj_cp.csv'
openPricePath = '~/Desktop/'
priceType = 'Live'
#########################################
...
def main():
    ...
    try:
        app = TestApp(action='LIVEPRICE', account=Account, openPricePath=openPricePath, tickerFile=pathTicker, priceType=priceType)
