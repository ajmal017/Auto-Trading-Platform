...
There are one main functions including:
    ...
    1. ACCOUNT: This function is to retrieve the portfolio status of the account and save the open position to a .csv file
...
# The directory to store the open position report
pathAccountSummary = '../Output/'
...
def main():
    ...
    try:
        app = TestApp(action='ACCOUNT', account=Account, acctFile=pathAccountSummary)
