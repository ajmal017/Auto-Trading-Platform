...
There are one main functions including:
    ...
    1. EXEC: This function is to check how many orders have been executed and save the executions to a .csv file
...
pathTicker = '/Users/andrew/Desktop/HKUST/Projects/IB/Test_1101/Data/HKCombine/Tickers.csv'
pathAllStock = '~/Desktop/AllStockData.csv'
...
def main():
    ...
    try:
        app = TestApp(action='HISTDATA', account=Account, tickerFile=pathTicker)
