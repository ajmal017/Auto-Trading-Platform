...
class TestApp(TestWrapper, TestClient):
    ...
    def pnlOperations(self):
        ...
        # ! [reqpnlsingle]
        self.reqPnLSingle(17002, "U9853025", "", 6030);
        # ! [reqpnlsingle]
        time.sleep(1)
        # ! [cancelpnlsingle]
    ...
    def historicalDataRequests_req(self):
        ...
        # ! [reqHistogramData]
        self.reqHistogramData(4104, ContractSamples.SEHK6030(), False, "3 days")
        # ! [reqHistogramData]
        time.sleep(2)
        # ! [cancelHistogramData]
    ...
    def orderOperations_req(self):
        ...
        self.reqOpenOrders()
        # ! [reqopenorders]
        self.placeOrder(self.nextOrderId(), ContractSamples.SEHK6030(), OrderSamples.LimitOrder(action='BUY', limitPrice=14.98, quantity=500 ))
        self.placeOrder(self.nextOrderId(), ContractSamples.USStock(), OrderSamples.MarketOrder('SELL', 200))
        self.placeOrder(self.nextOrderId(), ContractSamples.USStock(), OrderSamples.MarketOrder('BUY', 300))
        self.placeOrder(self.nextOrderId(), ContractSamples.USStock(), OrderSamples.MarketOrder('BUY', 400))
